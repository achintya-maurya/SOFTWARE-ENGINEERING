...
The Use Case Diagram represents the major actors of the system and the functions available to each actor. It establishes the functional boundary of the proposed system and shows the interaction between citizens, department officers, field workers, administrators, and the system.

% =================================================
% PUT YOUR USE CASE DIAGRAM HERE
% =================================================
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.70\textwidth]{../assets/Sequence.drawio.png}
